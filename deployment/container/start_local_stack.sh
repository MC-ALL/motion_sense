...
runtime_root="${PWD}/deployment/runtime"
config_root="${runtime_root}/config"
secret_root="${runtime_root}/secrets"
cert_root="${runtime_root}/certs"
data_root="${runtime_root}/data"
backend_config_root="${config_root}"
ops_config_root="${config_root}"
ops_data_root="${data_root}"
web_config_root="${config_root}"
...
mkdir -p "${backend_config_root}/backend/api_service"
mkdir -p "${config_root}/edge_processor" "${config_root}/device_simulator" "${config_root}/influxdb" "${config_root}/mosquitto"
mkdir -p "${ops_config_root}/ops_observer/api_service" "${ops_data_root}/ops_observer"
mkdir -p "${web_config_root}/web/portal_app"
...
cat > "${web_config_root}/web/portal_app/runtime_config.js" <<EOF
